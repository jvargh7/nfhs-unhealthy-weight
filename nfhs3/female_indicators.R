...
female <- readRDS(paste0(path_ecological_analysis,"/working/iair52_clean.RDS"))
...
bind_cols(india_female_cvd_indicators,
  ...
  saveRDS(.,paste0(path_ecological_analysis,"/working/n3 india_female_indicators.RDS"))
...
left_join(female_cvd_indicators,
          ...
          by = "state") %>% 
saveRDS(.,paste0(path_ecological_analysis,"/working/n3 state_female_indicators.RDS"))
...
left_join(region_female_cvd_indicators,
          ...
          by = c("state","v025")) %>% 
  saveRDS(.,paste0(path_ecological_analysis,"/working/n3 region_female_indicators.RDS"))
