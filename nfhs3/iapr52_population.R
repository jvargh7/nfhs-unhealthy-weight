...
iahr_population <- read_dta(paste0(path_india_raw_data,"/IAHR52DT/IAHR52FL.dta"),
  ...
  distinct(hv024,hv001,hv002,.keep_all=TRUE)

saveRDS(iahr_population,paste0(path_ecological_analysis,"/working/iahr52_population.RDS"))
rm(iahr_population)
