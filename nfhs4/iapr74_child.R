...
child_variables = c("hv001","hv002","hvidx","hv005","hv021","hv023",
                    "hc1","hv103","hc70","hc72",
                    "hc71","hc72","hc1","hc56",
...
iapr_child <- read_dta(paste0(path_india_raw_data,"/IAPR74DT/IAPR74FL.dta"),
...
saveRDS(iapr_child,paste0(path_ecological_analysis,"/working/iapr74_child.RDS"))
